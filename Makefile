all:
	...
	wasm kernel_q9.s
	wlink -o kernel_q9.srec kernel_q9.o serial_task.o parallel_task.o mtk/gameSelect.o mtk/breakout.o mtk/rocks.o
	...
	cp kernel_q9.srec /home/alin2299/Downloads
...
clean:
	...
	rm /home/alin2299/Downloads/kernel_q9.srec